...
import JobItem from '../../HomeLayout/MainContainer/TapsSection/JobItem';
import PortfioloCard from './PortfioloCard';
  ...
  return (
    <Stack
      ...
      <Stack
        ...
        <Stack justifyContent='flex-end' alignItems='end' spacing={1}>
          <Pagination count={4} />
        </Stack>
      </Stack>
